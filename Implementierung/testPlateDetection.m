...
- debugFlag ist nur zu Testzwecken gedacht. Ist es true, werden zusätzliche
  Debug-Informationen im Ausgabebild angezeigt.
- Zur Ausgabe der Bilder am Bildschirm das imshow in der untersten Schleife
  aktivieren.
- Die Bilder dauern durchschnittlich 90 Sekunden (Testgerät: i5 quadcore 
  mit 3.5 GHz), abhängig davon wieviele kleine Flächen gefunden werden 
  (z.B. Gras), weil die imfill Methode von Matlab dann länger braucht.
